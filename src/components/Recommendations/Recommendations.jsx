              ...
              {recommendations.length === 0 ? (
                <div className="item">
                  <div className="shadow-effect">
                    <img className="img-circle" src="https://via.placeholder.com/90" alt="User" />
                ...
                recommendations.map((recommendationDetail, index) => (
                  <RecommendationDetails recommendationDetail={recommendationDetail} key={index} />
                ))
              )}
            </OwlCarousel>
          </div>
